...
class EnvironmentDefinitionTests(unittest.TestCase):
    def test_unified_py310_environment_files_are_portable(self):
        ...
        self.assertIn('mamba-ssm', mamba_text)
        ...
        self.assertIn('causal_conv1d-1.0.2+cu118torch1.13cxx11abiFALSE-cp310-cp310-linux_x86_64.whl', script_text)
        self.assertIn('mamba_ssm-1.1.1+cu118torch1.13cxx11abiFALSE-cp310-cp310-linux_x86_64.whl', script_text)

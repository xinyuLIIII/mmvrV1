...
class AttentionBiLSTMTemporalDecoder(nn.Module):
    def __init__(
        self,
        d_model,
        num_frames,
        ...
        self.temporal_blocks = nn.ModuleList(
            ...
            for _ in range(attn_temporal_layers)
        )
        ...
        self.temporal_proj = nn.Linear(bilstm_hidden_dim * 2, d_model)
        ...
        self.query_blocks = nn.ModuleList(
            ...
            for _ in range(query_refine_layers)
        )
    ...
    def forward(self, tgt, pose_memory, memory, pos=None, query_pos=None):
        ...
        temporal, _ = self.temporal_bilstm(temporal)
...
class mmVR_AttnBiLSTM(nn.Module):
    def __init__(
        self,
        args,
        backbone,
        ...
        self.temporaldecoder = AttentionBiLSTMTemporalDecoder(
            d_model=d_model,
            ...
            dim_feedforward=dim_feedforward,
            dropout=dropout,
            attn_temporal_layers=attn_temporal_layers,
...
def build_model(args):
    ...
    model = mmVR_AttnBiLSTM(
        ...
        num_class=8,
        attn_temporal_layers=args.attn_temporal_layers,

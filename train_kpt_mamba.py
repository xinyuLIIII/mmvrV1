...
import config_mamba as config
from tensorboardX import SummaryWriter
from models.mmVR_Mamba import build_model
...
if __name__ == '__main__':
    ...
    amp_enabled = False
    if args.amp:
        print('AMP disabled in train_kpt_mamba for numerical stability.')
